...
def das(ctx, debug=False, username='mputnik'):
    ...
    for faults, batch_size, gamma, workers_per_node, nodes, runs, input_rate in [
        ...
        ### Impact of GAMMA ###
        # (1, 800, 1.0, 1, 5, 5, 4000),
        # (1, 800, 0.9, 1, 6, 5, 4000),
        # (1, 800, 0.8, 1, 7, 5, 4000),
        # (1, 800, 0.7, 1, 11, 5, 4000),
        # (1, 800, 0.6, 1, 21, 5, 4000),
        # (1, 800, 1.0, 1, 5, 5, 3000),
        #######################
        # (4, 800, 1.0, 4, 17, 5, 500),
        # (4, 800, 1.0, 4, 17, 5, 1000),
        # (4, 800, 1.0, 4, 17, 5, 1500),
        # (4, 800, 1.0, 4, 17, 5, 2000),
        # (4, 800, 1.0, 4, 17, 5, 2500),
        # (4, 800, 1.0, 4, 17, 5, 3000),
        # (4, 800, 1.0, 4, 17, 5, 3500),
        # (4, 800, 1.0, 4, 17, 5, 4000),
        # (4, 800, 1.0, 4, 17, 5, 4500),
        # (4, 800, 1.0, 4, 17, 5, 5000),
        ##### Changing N ######
        # (1, 800, 1.0, 1, 5, 5, 4000),
        # (1, 800, 1.0, 1, 6, 5, 4000),
        # (1, 800, 1.0, 1, 7, 5, 4000),
        # (1, 800, 1.0, 1, 8, 5, 4000),
        # (2, 800, 1.0, 1, 9, 5, 4000),
        # (2, 800, 1.0, 1, 10, 5, 4000),
        # (2, 800, 1.0, 1, 11, 5, 4000),
        # (2, 800, 1.0, 1, 12, 5, 4000),
        # (3, 800, 1.0, 1, 13, 5, 4000),
        # (3, 800, 1.0, 1, 14, 5, 4000),
        # (3, 800, 1.0, 1, 15, 5, 4000),
        # (3, 800, 1.0, 1, 16, 5, 4000),
        # (4, 800, 1.0, 1, 17, 5, 4000),
        # (4, 800, 1.0, 1, 18, 5, 4000),
    ]:
        ...
        while run < runs:
            try:
                ...
                if ret._consensus_duration() <= 40:
                    print(f"Repeat as consensus duration is: {ret._consensus_duration()}")
                    continue
